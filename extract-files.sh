...
PRODUCT_COPY_FILES += \\
    ...
    vendor/samsung/__DEVICE__/proprietary/lib/libganril.so:system/lib/libganril.so \\
    ...
    vendor/samsung/__DEVICE__/proprietary/lib/librilswitch.so:system/lib/librilswitch.so \\
